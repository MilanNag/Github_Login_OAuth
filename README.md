...
An React app that implements "Login with GitHub" functionality.

### Usage and Setup
- Clone this repo. Go into the root folder and run *yarn* or *npm start* to install the dependencies.
